...
describe("SEO component", () => {
  ...
  const mockUseStaticQuery = {
    site: {
      siteMetadata: {
        description:
          "Kiki For The Future. Get a fresh take on what you didn't learn in sex-ed.",
        image: "/card.png",
  ...
  it("renders default metadata", async () => {
    ...
    expect(ogImage).toHaveAttribute(
      "content",
      defaults.siteUrl + defaults.image
    );
    ...
    expect(twitterImageAlt).toHaveAttribute(
      "content",
      defaults.twitterImageAlt
    );
  });
  ...
  it("overrides default image", async () => {
    ...
    expect(ogImage).toHaveAttribute(
      "content",
      defaults.siteUrl + overrides.image
    );
  });
  ...
  it("overrides default siteUrl", async () => {
    ...
    expect(ogUrl).toHaveAttribute(
      "content",
      defaults.siteUrl + "/" + overrides.siteUrl
    );
  });
